        ...
        set: {
          position: function(position, calculations) {
            ...
            if(module.should.centerArrow(calculations)) {
              module.verbose('Adjusting offset to user_base arrow on small target element');
...
$.fn.popup.settings = {
  ...
  // number of pixels from edge of popup to pointing arrow user_base (used from centering)
  ...
  className   : {
    ...
    loading      : 'loading',
    popup        : 'ui popup',
    position     : 'top left user_base bottom right',
    visible      : 'visible',
