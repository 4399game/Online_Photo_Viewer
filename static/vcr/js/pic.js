    ...
    add_pic = function(){
        // 图片的base64 转为blob对象 并且添加到form_data中
    ...
    // 修改相册
    open_edit_pic_modal = function(pic_id) {
    ...
    // 删除相册
    open_del_pic_modal = function(pic_id) {
